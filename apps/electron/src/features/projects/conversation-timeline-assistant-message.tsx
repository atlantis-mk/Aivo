...
function AssistantCompletionStatus({
  ...
  return (
    <div
      className="aivo-assistant-status mb-3 animate-in border-b border-border/60 pb-3 fade-in slide-in-from-bottom-2 duration-300"
      role="status"
    >
      {children}
    </div>
...
export function AssistantResponse({
  ...
  return (
    <div className="aivo-assistant-response group/assistant-response relative">
      ...
      />
      <div className="relative mb-3 mt-2 h-6">
