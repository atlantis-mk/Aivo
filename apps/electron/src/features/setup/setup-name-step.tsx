    ...
    <section className="relative flex min-h-dvh flex-col overflow-hidden bg-background">
      <div className="flex flex-1 items-center justify-center px-4 py-8 sm:px-8">
        <div className="flex w-full max-w-[420px] flex-col items-center text-center">
          ...
          <div className="mt-8 w-full rounded-2xl border border-border/80 bg-card p-4 text-left shadow-sm shadow-foreground/[0.03]">
            ...
            <Input
              autoFocus
              className="mt-2 h-10 rounded-xl bg-background px-3 text-sm font-medium shadow-none"
              id="setup-app-name"
            ...
            <div className="mt-3 flex min-w-0 items-center gap-3 rounded-xl bg-muted/55 px-3 py-2 text-sm">
              <span className="shrink-0 text-muted-foreground">首页预览</span>
