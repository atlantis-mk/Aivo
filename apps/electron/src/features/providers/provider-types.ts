...
export type VolcengineProviderVariant = {
  id: "volcengine-agent-plan" | "volcengine-coding-plan" | "volcengine";
  label: string;
};

export const volcengineProviderVariants: VolcengineProviderVariant[] = [
  { id: "volcengine-agent-plan", label: "Agent Plan" },
  { id: "volcengine-coding-plan", label: "Coding Plan" },
  { id: "volcengine", label: "普通 API" },
];
