...
function AttachmentActions({
  ...
  return (
    <div
      ...
      className={cn(
        "relative z-20 flex shrink-0 items-center group-data-[orientation=vertical]/attachment:absolute group-data-[orientation=vertical]/attachment:top-1 group-data-[orientation=vertical]/attachment:right-1 group-data-[orientation=vertical]/attachment:gap-1",
        className
      )}
      {...props}
    />
