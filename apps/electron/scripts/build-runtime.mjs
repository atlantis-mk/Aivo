...
const cargoManifest = resolve(workspaceRoot, "vendor/codex/codex-rs/Cargo.toml");
const release = process.argv.includes("--release");
const fastRelease = process.argv.includes("--fast-release");
const hostOnly = process.argv.includes("--host-only");
const debugCodexPath = resolve(workspaceRoot, "vendor/codex/codex-rs/target/debug/codex");
...
const artifactDirectory = resolve(
  workspaceRoot,
  "vendor/codex/codex-rs/target/aivo-rusty-v8",
  v8Version,
  target,
);
