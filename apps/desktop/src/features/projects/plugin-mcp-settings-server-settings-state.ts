import { useMcpServerCapabilityState } from "@/features/projects/plugin-mcp-settings-server-capability-state";
import { useMcpServerDraftState } from "@/features/projects/plugin-mcp-settings-server-draft-state";
