...
func defaultPromptContracts() map[string]promptContract {
	...
	add("auxiliary.host_tool_groups.system", domain.PromptCategoryAuxiliary, true, false, []string{"selection_rule", "intent_shape"}, []string{"selection_rule", "intent_shape"})
	add("auxiliary.host_tool_groups.user", domain.PromptCategoryAuxiliary, true, false, []string{"intent", "candidates"}, []string{"intent", "candidates"})
